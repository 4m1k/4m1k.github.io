(function() {
  ...
  function component(object) {
    ...
    var balansers_with_search = ['kinotochka', 'kinopub', 'lumex','redheadsound', 'animevost', 'animego', 'animedia', 'animebesst', 'anilibria', 'rezka', 'rhsprem', 'kodik', 'remux', 'animelib', 'kinoukr', 'rc/kinopub', 'rc/rhs', 'vcdn'];
  ...
  function startPlugin() {
    ...
    if (Lampa.Manifest.app_digital >= 177) {
      var balansers_sync = ["rezka", "rhsprem", "lumex", "videodb", "collaps", "hdvb", "zetflix", "kodik", "ashdi", "kinoukr", "kinotochka", "remux", "iframevideo", "cdnmovies", "anilibria", "animedia", "animego", "animevost", "animebesst", "redheadsound", "alloha", "animelib", "moonanime", "kinopub", "vibix", "vdbmovies", "fancdn", "cdnvideohub", "vokino", "rc/kinopub", "rc/rhs", "vcdn"];
