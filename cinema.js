 ...
 if (uniqueId !== "tyusdt") {
  ...
  function startPlugin() {
    ...
    Lampa.Listener.follow('full', function(e) {
      if (e.type == 'complite') {
        setTimeout(function(){
                $(".view--online_cinema", Lampa.Activity.active().activity.render()).empty().append('<svg fill="currentColor" id="Capa_1" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><g><path d="m310.873 31h-55.939l24.897 45h56.058z"></path><path d="m443.101 151h68.899v-45h-50.898z"></path><path d="m425.808 76-25.261-45h-55.613l24.897 45z"></path><path d="m220.873 31h-55.939l24.897 45h56.058z"></path><path d="m338.375 106h-57.273l-18.001 45h57.717z"></path><path d="m248.375 106h-57.273l-18.001 45h57.717z"></path><path d="m256 406c41.353 0 75-33.647 75-75s-33.647-75-75-75-75 33.647-75 75 33.647 75 75 75zm-31.816-106.816c17.549-17.549 46.084-17.549 63.633 0 5.859 5.859 5.859 15.352 0 21.211s-15.352 5.859-21.211 0-15.352-5.859-21.211 0c-5.845 5.845-5.845 15.366 0 21.211 5.859 5.859 15.352 5.859 21.211 0s15.352-5.859 21.211 0 5.859 15.352 0 21.211c-17.532 17.532-46.084 17.549-63.633 0s-17.549-46.085 0-63.633z"></path><path d="m428.375 106h-57.273l-18.001 45h57.717z"></path><path d="m497 31h-62.326l25.117 45h52.209v-30c0-8.291-6.709-15-15-15z"></path><path d="m0 466c0 8.291 6.709 15 15 15h482c8.291 0 15-6.709 15-15v-285h-512zm151-135c0-16.165 3.977-31.307 10.532-45h-55.532c-8.291 0-15-6.709-15-15s6.709-15 15-15h76.749c18.939-18.499 44.753-30 73.251-30s54.313 11.501 73.251 30h76.749c8.291 0 15 6.709 15 15s-6.709 15-15 15h-55.532c6.555 13.693 10.532 28.835 10.532 45s-3.977 31.307-10.532 45h55.532c8.291 0 15 6.709 15 15s-6.709 15-15 15h-76.749c-18.939 18.499-44.753 30-73.251 30s-54.313-11.501-73.251-30h-76.749c-8.291 0-15-6.709-15-15s6.709-15 15-15h55.532c-6.555-13.693-10.532-28.835-10.532-45z"></path><path d="m164.228 91-33.354-60h-115.874c-8.291 0-15 6.709-15 15v105h140.818z"></path></g></svg>
&nbsp&nbspCinema');
        }, 5);
