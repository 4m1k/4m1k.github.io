		...
		Lampa.SettingsApi.addParam({
			...
			Lampa.SettingsApi.addParam({
				...
				Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://4m1k.github.io/snow.js', 'Snow', '@lampa', 'Snow');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://4m1k.github.io/snow.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://4m1k.github.io/snow.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://4m1k.github.io/snow.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://4m1k.github.io/snow.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
		    ...
		    Lampa.SettingsApi.addParam({
				...
				Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://4m1k.github.io/notrailer.js', 'Удаление Трейлеров', '@lampa', 'NoTrailer');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://4m1k.github.io/notrailer.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://4m1k.github.io/notrailer.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://4m1k.github.io/notrailer.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://4m1k.github.io/notrailer.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
...
/* Клубника */
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('http://4m1k.github.io/sisi.js', 'Клубничка (sisi)', '@lampa', 'sisi');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "http://4m1k.github.io/sisi.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('http://4m1k.github.io/sisi.js')
						setTimeout(function() {	
							$('div[data-name="sisi"]').append('<div class="settings-param__status one"></div>')
							if (myResult) {
								$('div[data-name="sisi"]').find('.settings-param__status').removeClass('active error wait').addClass('active')
						...
						var myResult = checkPlugin('http://4m1k.github.io/sisi.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'http://4m1k.github.io/sisi.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
