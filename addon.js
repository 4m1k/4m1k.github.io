...
/* Интерфейс */
		...
		Lampa.SettingsApi.addParam({
			...
			Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://4m1k.github.io/tmdbalt.js', 'TMDB Alt', '@lampa', 'TMDB Alt');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://4m1k.github.io/tmdbalt.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://4m1k.github.io/tmdbalt.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://4m1k.github.io/tmdbalt.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://4m1k.github.io/tmdbalt.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
				...
				Lampa.SettingsApi.addParam({
					...
					onRender: function (item) {
						$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://4m1k.github.io/interface_mod.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://4m1k.github.io/interface_mod.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://4m1k.github.io/interface_mod.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://4m1k.github.io/movies.js', 'Ru En Кинотеатры', '@lampa', 'Ru En Кинотеатры');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://4m1k.github.io/movies.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {
						$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('https://4m1k.github.io/movies.js')
						setTimeout(function() {	
						...
						var myResult = checkPlugin('https://4m1k.github.io/movies.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://4m1k.github.io/movies.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://4m1k.github.io/quality.js', 'В Качестве', '@lampa', 'qual');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://4m1k.github.io/quality.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://4m1k.github.io/quality.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://4m1k.github.io/quality.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://4m1k.github.io/lampa_rate.js', 'Рейтинг Lampa', '@lampa', 'rate_lampa');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://4m1k.github.io/lampa_rate.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						...
						var myResult = checkPlugin('https://4m1k.github.io/lampa_rate.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'https://4m1k.github.io/lampa_rate.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
...
/* Онлайн */
		Lampa.SettingsApi.addParam({
			...
			Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('http://lampa.app/online.js', 'Lampa.app Online', '@lampa', 'Lampa.app Online');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "http://lampa.app/online.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						/*var myResult = checkPlugin('http://lampa.app/online.js')
						setTimeout(function() {	
							$('div[data-name="Lampa.app Online"]').append('<div class="settings-param__status one"></div>')
							if (myResult) {
								$('div[data-name="Lampa.app Online"]').find('.settings-param__status').removeClass('active error wait').addClass('active')
							} else {
								$('div[data-name="Lampa.app Online"]').find('.settings-param__status').removeClass('active error wait').addClass('error')
							}
						}, 100);*/
						var myResult = checkPlugin('http://lampa.app/online.js');
                                                var pluginsArray = Lampa.Storage.get('plugins');
                                                    setTimeout(function() {
                                                       ...
                                                       var pluginStatus = null;
                                                       for (var i = 0; i < pluginsArray.length; i++) {
                                                          if (pluginsArray[i].url === 'http://lampa.app/online.js') {
                                                             pluginStatus = pluginsArray[i].status;
                                                             break;
                                                          }
                                                       }
                                                       if (myResult && pluginStatus !== 0) {
                                                          $('div[data-name="Lampa.app Online"]').find('.settings-param__status').removeClass('active error').addClass('active');
                                                       } else if (pluginStatus === 0) {
                                                          $('div[data-name="Lampa.app Online"]').find('.settings-param__status').removeClass('active error').css('background-color', 'rgb(255, 165, 0)');
                                                       } else {
                                                          $('div[data-name="Lampa.app Online"]').find('.settings-param__status').removeClass('active error').addClass('error');
                                                       }
                                                    }, 100);
					}
        });
