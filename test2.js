document.addEventListener('DOMContentLoaded', function(){
  console.log('DOM полностью загружен, запускаем KP код');

  (function(){
    'use strict';

    try {
      console.log('KP script executing');
      ...
      // Пытаемся запустить через Lampa.Listener, если он доступен, иначе через setTimeout
