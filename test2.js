(function(){
  ...
  try {
    ...
    if (!Lampa.Api.sources.KP) {
      ...
      // Функции для обработки заголовков
      ...
      // Сетевые функции с префиксом KP_
      ...
      // Функция загрузки списка элементов по категории
      ...
      // Stub-реализации функций main и category уже заданы: KP_main и KP_category
      function KP_full() {
        var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        var oncomplite = arguments.length > 1 ? arguments[1] : undefined;
        var onerror = arguments.length > 2 ? arguments[2] : undefined;
      ...
      // Stub-реализации main и category уже заданы как KP_main и KP_category
      ...
      function addKPButton() {
        ...
        var tvItem = menuEl.find('[data-action="tv"]');
        if (tvItem.length) {
