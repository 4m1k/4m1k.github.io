...
>
  <!-- Группа как в примере -->
  <g id="Page-1" fill="none" fill-rule="evenodd">
    <!-- Внутренняя группа с вашим логотипом -->
    <g id="K-Icon" fill="rgb(0,0,0)" fill-rule="nonzero">
      
      <!-- 1) Квадратная рамка со скруглёнными углами (кольцевая форма) -->
      <path
        id="Square-Outline"
        fill="currentColor"
        fill-rule="evenodd"
        d="
          <!-- Внешний прямоугольник с радиусом 16 -->
          M20,4
          H172
          A16,16 0 0 1 188,20
          V172
          ...
          A16,16 0 0 1 20,4
          Z
          <!-- Внутренний прямоугольник (вычитаем) со смещением 14 px, радиус = 2 -->
          M20,18
          H172
          A2,2 0 0 1 174,20
          V172
      ...
      <!-- 2) Буква «K» (смещаем влево для центровки внутри 192×192) -->
