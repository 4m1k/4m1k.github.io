(function() {
  ...
  if (!window.rch) {
    Lampa.Utils.putScript(["https://cf-stream.stull.xyz/invc-rch.js"], function() {}, false, function() {
      if (!window.rch.startTypeInvoke)
        window.rch.typeInvoke('https://cf-stream.stull.xyz', function() {});
    }, true);
  }
  ...
  function component(object) {
    ...
    if (balansers_with_search == undefined) {
      ...
      network.silent(account('https://cf-stream.stull.xyz/lite/withsearch'), function(json) {
