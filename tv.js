...
/* Исправление видимости кнопки "Категории" */
...
'.info__left > div{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}' +
'.info__right{flex:0 0 auto;margin-left:1em;}' +
...
langAdd('default_playlist',
    {
ru: 'https://4m1k.github.io/tv.m3u',
...
uk: 'За замовчуванням використовується плейлист із проекту <i>https://github.com/Free-TV/IPTV<br>Ви можете замінити його на свій.',
be: 'Па змаўчанні выкарыстоўваецца плэйліст з праекта <i>https://github.com/Free-TV/IPTV<br>Вы можаце замяніць яго на свой.',
en: 'The default playlist is from the project <i>https://github.com/Free-TV/IPTV<br>You can replace it with your own.',
zh: '默认播放列表来自项目 <i>https://github.com/Free-TV/IPTV<br>您可以将其替换为您自己的。'
    }
);
...
field: {
    name: !param.title ? param.name : param.title
}
    }
