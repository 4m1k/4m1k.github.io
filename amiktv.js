/* Обновленный код с новой ссылкой на плейлист */
;(function () {
'use strict';
...
// Замененные ссылки на плейлисты
...
// Логирование загрузки плейлиста
function testPlaylistLoad() {
    const playlistUrl = 'http://tv.new-ton.net.ru/plamik.m3u';
    console.log('Попытка загрузить плейлист:', playlistUrl);
    ...
    fetch(playlistUrl)
        ...
        .then(data => {
            console.log('Плейлист успешно загружен. Пример данных:', data.slice(0, 200));
        })
        .catch(error => {
...
// Запуск теста при старте скрипта
testPlaylistLoad();
