(function() {
  ...
  function component(object) {
    ...
    function account(url) {
      ...
      // Здесь вместо получения токена из хранилища вставляем фиксированное значение
    ...
    // ... остальные функции плагина остаются без изменений ...
    // (Полный код плагина взят из файла "онлайн актёр.txt" :contentReference[oaicite:0]{index=0}–&#8203;:contentReference[oaicite:1]{index=1})

    // Функция startPlugin, настройки манифеста и языковые переводы:
