...
var ACCOUNT_EMAIL_B64 = "bGlzaXl2aXJ1c0BnbWFpbC5jb20=";
var UID = "ofkrtxdg";
	...
	function iptvskaz(object) {
		...
		console.log('Skaz','days:','29');
		var catalogs = [{
        title: 'Общие каналы',
        url: 'http://'+domain+'/ch.json?ico='+skazico+'&ua='+Lampa.Storage.cache("skazua")+'&email=\" + ACCOUNT_EMAIL_B64 + \"&uid=\" + UID'
		},
		{
        title: 'Избранное',
        url: 'http://skaz.tv/ch.json?fav=1&cdn='+scdn+'&ua='+Lampa.Storage.cache("skazua")+'&email=\" + ACCOUNT_EMAIL_B64 + \"&uid=\" + UID'
		}, {
			title: 'VIP Федеральные',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%A4%D0%B5%D0%B4%D0%B5%D1%80%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Новости',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%9D%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D0%B8&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Фильмы',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%A4%D0%B8%D0%BB%D1%8C%D0%BC%D1%8B&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Кинозалы',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%9A%D0%B8%D0%BD%D0%BE%D0%B7%D0%B0%D0%BB%D1%8B&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP UHD',
			url: 'http://skaz.tv/tvpl.json?gr=UHD&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP HDR',
			url: 'http://skaz.tv/tvpl.json?gr=HDR&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Детские',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%94%D0%B5%D1%82%D1%81%D0%BA%D0%B8%D0%B5&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Спорт',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%A1%D0%BF%D0%BE%D1%80%D1%82&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Музыка',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%9C%D1%83%D0%B7%D1%8B%D0%BA%D0%B0&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Образование',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%9E%D0%B1%D1%80%D0%B0%D0%B7%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Природа',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%9F%D1%80%D0%B8%D1%80%D0%BE%D0%B4%D0%B0&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Плюсовые',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%9F%D0%BB%D1%8E%D1%81%D0%BE%D0%B2%D1%8B%D0%B5&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},{
			title: 'VIP Прочее',
			url: 'http://skaz.tv/tvpl.json?gr=%D0%9F%D1%80%D0%BE%D1%87%D0%B5%D0%B5&rand=5541&cmail=c0iUqfEhjEe6sie30aDWCAJ3wHR3xPMApePVfvrKCFM%3D&cdn='+scdn
			},		{
        title: 'Скрытые вами каналы',
      url: 'http://skaz.tv/ch.json?nodisplay=1&email=\" + ACCOUNT_EMAIL_B64 + \"&uid=\" + UID'
		}
		];	
				Lampa.Storage.set('skaz_vip',1);
		if (Lampa.Storage.get("noporn")!='1') catalogs.push({title: 'Ночные', url: 'http://skaz.tv/ch.json?gr=%D0%92%D0%B7%D1%80%D0%BE%D1%81%D0%BB%D1%8B%D0%B5&email=\" + ACCOUNT_EMAIL_B64 + \"&uid=\" + UID'});
		...
		this.append = function (data) {
			...
			data.forEach(function (element) {
				...
				card.on('hover:enter', function () {
					...
					var playlist=[],i=1;data.forEach((function(a){playlist.push({title:a.tvtitle,url:a.tvmedia}),i++})),video['playlist']=playlist,video['iptv']=true;Lampa.Player.play(video);$(".noti").html(element.tvid);
					console.log('Skaz',' URL: ',video.url);
					console.log('Skaz',' Method: ',Lampa.Storage.get('player_hls_method'));
					if(cache_name.includes("tvpl.json")||cache_name.includes("fav=1")){
						playlist=[];$.get("http://skaz.tv/archive.json?email=bGlzaXl2aXJ1c0BnbWFpbC5jb20=&name="+encodeURI(element.tvtitle.replace("+","__"))+"&cdn="+scdn+"&ur="+encodeURI(element.tvmedia), function(data, status) {if (status === "success") {if(Array.isArray(data)){data.forEach(function(item) {playlist.push({ title: item.tvtitle, url: item.tvmedia });});Lampa.Player.playlist(playlist);}}});
						}
						else
						{
...
this.addicon=function(c,a){a.find(".card__icons-inner").append('<div class="card__icon icon--'+c+'"></div>')},this.favorite=function(c,a){!cache||cache&&-1==cache.indexOf(c.tvtitle)?cache?cache.push(c.tvtitle):cache=[c.tvtitle]:(Lampa.Arrays.remove(cache,c.tvtitle),Lampa.Storage.set("fav_skazchns",cache)),a.find(".card__icons").remove(),cache.indexOf(c.tvtitle)>-1&&this.addicon("book",a),Lampa.Storage.set("fav_skazchns",cache),searched=!0,this.back()},this.notdispl=function(c,a){!cache||cache&&-1==cache.indexOf('not'+c.tvtitle)?cache?cache.push('not'+c.tvtitle):cache=['not'+c.tvtitle]:(Lampa.Arrays.remove(cache,'not'+c.tvtitle),Lampa.Storage.set("fav_skazchns",cache)),Lampa.Storage.set("fav_skazchns",cache),searched=!0,this.back()};
		this.build = function(data) {
			...
			var btn=Lampa.Template.get("button_category"),btn2=Lampa.Template.get("button_category3"),btn3=Lampa.Template.get("button_podp");info=Lampa.Template.get("info_radio"),info.find("#stantion_filtr").append(btn2),info.find("#stantion_filtr").append(btn3),info.find("#stantion_filtr").append(btn),info.find(".view--category").on("hover:enter hover:click",(function(){_this2.selectGroup()})),info.find(".view--podp").on("hover:enter hover:click",(function(){_this2.selectGroup2()})),info.find(".select__fav").on("hover:enter hover:click",(function(){Lampa.Activity.push({url:"http://skaz.tv/ch.json?fav=1&cdn="+scdn+"&ua="+Lampa.Storage.cache('skazua')+"&email=\" + ACCOUNT_EMAIL_B64 + \"&uid=\" + UID",title:"Избранное",component:"iptvskaz",page:1})}));
    ...
    nosave: !0
		...
		Lampa.Activity.push({
        url: "http://"+domain+"/ch.json?search="+t+"&email=\" + ACCOUNT_EMAIL_B64 + \"&uid=\" + UID",
        title: "Поиск",
        component: "iptvskaz",
        page: 1
		});
		...
		this.selectGroup2 = function () {
					  var modal = '<div><div class="broadcast__text" style="text-align:left"><h4 style="margin-bottom: 5px;">Ваш E-mail для активации подписки: lisiyvirus@gmail.com</h4>У вас активна подписка на каналы. Осталось дней: <b>29</b><br/>&bull; Каналы с пометкой VIP можно найти в меню Разделы.<br/>&bull; Продлить подписку можно по QR коду ниже или на сайте skaz.tv. Возможна оплата по номеру СБП, стран СНГ, криптовалютой.<br/>Ваш токен для бота: ae1efc0c6f<br/><div class="skazsbp2" style="margin-bottom: -17px;"></div><span class="skazsbp"><br/><div class="simple-button selector skazback">QR код для оплаты (Pally)</div><div class="simple-button selector skaznext">QR код для оплаты (Over, автоматом не закрывается)</div></span><br clear="both"/>Так же возможна оплата с Европы с карты, USDT, WMZ.<br/>Оплатить или взять тест на сайте <span style="color:#0de0fc">skaz.tv</span></td></tr></table></div></div>';
			...
			skazback.on('hover:enter', function () {
			 $.get( 
                  ...
                  { billId: "1377c25665bbd326fe79dd720231928c8",
			...
			window.open('http://skaztv.online/oplata.php?amount=220&lifetime=2025-09-22T2359&billId=1377c25665bbd326fe79dd720231928c8&comment=lisiyvirus@gmail.com&email=lisiyvirus@gmail.com&ino=4')
			});
		...
		this.stop=function(){},this.render=function(){return html},this.destroy=function(){scroll.destroy(),info&&info.remove(),html.remove(),body.remove(),network=null,items=null,html=null,body=null,info=null};
			...
			function add() {
				...
				menu_itemss.on('hover:enter', function() {
					Lampa.Activity.push({
						url: 'http://skaz.tv/ch.json?ua='+Lampa.Storage.cache("skazua")+'&email=\" + ACCOUNT_EMAIL_B64 + \"&uid=\" + UID',						title: 'ТВ by skaz',
						component: 'iptvskaz',
						page: 1
					});
				});
...
if (starts < 1) {
	...
	$.get('http://geo.lampadev.ru/',function(data){Lampa.Storage.set("skazgeo",data);if (data=='RU' && scdn=='') {scdn='2';console.log('Skaz','GEO INSTALL',data);Lampa.Storage.set("skazcdn",2);}});
	if (Lampa.Storage.get('online_skaz')!=true) {
	$.getScript('http://skaz.tv/onlines.js');
	//if (location.hostname=='lampa.byskaz.ru' || location.hostname=='kz.byskaz.ru') $.getScript('http://skaz.tv/m2.js');
	}
	$.getScript('http://skaz.tv/ping.js');
			Lampa.Storage.set('lastonline_lampacskaz',1);
		...
		if (Lampa.Storage.get('online_skaz2')==true && !window.plugin_skazonline2) {
			$.getScript('http://skaztv.online/play.js');
			}
	    if (!window.plugin_iptv_ready2 && Lampa.Storage.get("noskaz2")!='1') $.getScript('http://skaztv.online/tv2.js?email=bGlzaXl2aXJ1c0BnbWFpbC5jb20=');
