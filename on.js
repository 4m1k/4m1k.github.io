(function() {
  ...
  function startPlugin() {
    ...
    Lampa.Listener.follow('full', function(e) {
      if (e.type == 'complite') {
        setTimeout(function(){
                $(".view--online", Lampa.Activity.active().activity.render()).empty().append('<?xml version="1.0" encoding="UTF-8"?>
<svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50.11 47.08" style="filter: invert(100%);">
  <defs>
